...
{
    public class ModelDrawingRvtIdVirtualTableRoute : AbstractShardingOperatorVirtualTableRoute<ModelDrawingRvtId, string>
    {
        private readonly IServiceProvider _serviceProvider;

        public ModelDrawingRvtIdVirtualTableRoute(IServiceProvider serviceProvider)
        {
            _serviceProvider = serviceProvider;
        }
        public override void Configure(EntityMetadataTableBuilder<ModelDrawingRvtId> builder)
        {
