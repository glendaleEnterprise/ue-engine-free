...
{
    public class ModelSpaceVirtualTableRoute : AbstractShardingOperatorVirtualTableRoute<ModelSpace, string>
    {
        private readonly IServiceProvider _serviceProvider;

        public ModelSpaceVirtualTableRoute(IServiceProvider serviceProvider)
        {
            _serviceProvider = serviceProvider;
        }
        public override void Configure(EntityMetadataTableBuilder<ModelSpace> builder)
        {
