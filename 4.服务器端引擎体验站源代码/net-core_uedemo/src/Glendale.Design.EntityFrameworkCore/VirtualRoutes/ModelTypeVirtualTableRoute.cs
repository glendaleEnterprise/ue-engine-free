...
{
    public class ModelTypeVirtualTableRoute : AbstractShardingOperatorVirtualTableRoute<ModelType, string>
    {
        private readonly IServiceProvider _serviceProvider;

        public ModelTypeVirtualTableRoute(IServiceProvider serviceProvider)
        {
            _serviceProvider = serviceProvider;
        }
        public override void Configure(EntityMetadataTableBuilder<ModelType> builder)
        {
