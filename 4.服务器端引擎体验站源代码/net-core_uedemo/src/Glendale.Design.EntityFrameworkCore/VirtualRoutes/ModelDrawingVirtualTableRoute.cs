...
{
    public class ModelDrawingVirtualTableRoute : AbstractShardingOperatorVirtualTableRoute<ModelDrawing, string>
    {
        private readonly IServiceProvider _serviceProvider;

        public ModelDrawingVirtualTableRoute(IServiceProvider serviceProvider)
        {
            _serviceProvider = serviceProvider;
        }
        public override void Configure(EntityMetadataTableBuilder<ModelDrawing> builder)
        {
