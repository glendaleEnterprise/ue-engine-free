...
{
    public class ModelTreeVirtualTableRoute : AbstractShardingOperatorVirtualTableRoute<ModelTree, string>
    {
        private readonly IServiceProvider _serviceProvider;

        public ModelTreeVirtualTableRoute(IServiceProvider serviceProvider)
        {
            _serviceProvider = serviceProvider;
        }
        public override void Configure(EntityMetadataTableBuilder<ModelTree> builder)
        {
