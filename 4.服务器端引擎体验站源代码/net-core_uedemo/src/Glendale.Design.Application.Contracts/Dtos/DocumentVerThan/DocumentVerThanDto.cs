...
{
    public class DocumentVerThanDto : AuditedEntityDto<Guid>
    {
        #region 
        /// <summary>
        /// 标题
        ...
        #region 补充属性
        public virtual ICollection<MetadataCreateDto> AddMetadatas { get; set; }
        public virtual ICollection<MetadataCreateDto> UpdateMetadatas { get; set; }
        public virtual ICollection<MetadataCreateDto> DeleteMetadatas { get; set; }
        #endregion
    }
}
