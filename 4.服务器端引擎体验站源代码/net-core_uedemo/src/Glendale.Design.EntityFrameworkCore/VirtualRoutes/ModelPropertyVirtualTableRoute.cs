...
{
    public class ModelPropertyVirtualTableRoute : AbstractShardingOperatorVirtualTableRoute<ModelProperty, string>
    {
        private readonly IServiceProvider _serviceProvider;

        public ModelPropertyVirtualTableRoute(IServiceProvider serviceProvider)
        {
            _serviceProvider = serviceProvider;
        }
        public override void Configure(EntityMetadataTableBuilder<ModelProperty> builder)
        {
